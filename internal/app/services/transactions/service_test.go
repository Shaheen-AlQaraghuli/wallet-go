	...
	tests := []struct {
		...
		},
		{
			...
			mockSetup: func(m *mocks.MockTransactionRepo) {
				...
				Return([]models.Transaction{}, &pagination.Pagination{}, errors.New("database error"))
			},
	...
	tests := []struct {
		...
		},
		{
			...
			mockSetup: func(tr *mocks.MockTransactionRepo, c *mocks.MockCacheClient) {
				...
				tr.On("ListAllTransactions", mock.Anything, "wallet-999").
					Return(models.Transactions{}, errors.New("database error"))
			},
			expectedError: "database error",
		},
	}
